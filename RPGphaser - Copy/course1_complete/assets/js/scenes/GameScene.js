class GameScene extends Phaser.Scene {
  ...
  createPlayer(playerObject) {
    this.player = new PlayerContainer(this, playerObject.x * 2, playerObject.y * 2, 'characters', 0, playerObject.health, playerObject.maxHealth, playerObject.id ,this.playerAttackAudio);
  }
  ...
  spawnMonster(monsterObject){
    ...
    if (!monster) {
      monster = new Monster(this, monsterObject.x * 2, monsterObject.y * 2, 'monsters', monsterObject.frame, monsterObject.id, monsterObject.health, monsterObject.maxHealth );
  ...
  addCollisions() {
    ...
    // check for collisions between monster group and wall objects
    this.physics.add.collider(this.monsters, this.map.blockedLayer);
    // check for colision between player's weapon and monster object
    this.physics.add.collider(this.player.weapon, this.monsters, this.enemyOverlap, null, this);
  }
